            ...
            {nowIsLoading && topIsLoading && upcomingIsLoading && popularIsLoading ? (
                ...
                <>
                    ...
                    <SliderWrapper>
                        ...
                        <MovieSlider section="movies" keyPlus="now" data={nowData!} top={-25} />
                        <Category $top={280}>TOP 평점 영화</Category>
                        <MovieSlider section="movies" keyPlus="top" data={topData!} top={305} />
                        <Category $top={610}>지금 인기 많은 영화</Category>
                        <MovieSlider section="movies" keyPlus="popular" data={popularData!} top={635} />
                        <Category $top={940}>개봉 예정 영화</Category>
                        <MovieSlider section="movies" keyPlus="upcoming" data={upcomingData!} top={965} />
                    </SliderWrapper>
                </>
            )}
        </Wrapper>
